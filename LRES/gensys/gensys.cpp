 ...
 * 08/10/15
 *
 * Requires the 'Armadillo' C++ linear algebra library.
 */
#include <iostream>
#include "armadillo"
//
 ...
 */
int gensys(arma::mat & G1, arma::mat & Cons, arma::mat & impact,
           arma::cx_mat & fmat, arma::cx_mat & fwt, arma::cx_mat & ywt,
           arma::cx_mat & gev, arma::vec & eu, arma::mat & loose,
           arma::mat Gamma0, arma::mat Gamma1, arma::mat C, arma::mat Psi, arma::mat Pi)
{
    //
    int n = Gamma0.n_rows;
    //
    ...
    //
    arma::cx_mat Q1 = Q.rows(0,n-nstable-1);
    arma::cx_mat Q2 = Q.rows(n-nstable,n-1);
    arma::cx_mat Z1 = arma::trans(Z.cols(0,n-nstable-1));
    arma::cx_mat Z2 = arma::trans(Z.cols(n-nstable,n-1));
	...
	*/
    ...
    //
    ywt = G0I.cols(usix-1,n-1);
    //
    loose_temp.set_size(n,neta);
    loose_temp.zeros();
    loose_temp.rows(0,n-nstable-1) = etawt1 * (arma::eye<arma::cx_mat>(neta,neta) - veta * arma::trans(veta));
